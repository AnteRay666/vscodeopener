<template>
  <div class="p-8">
    ...
    <div v-if="fileContent" class="mt-4 p-4 border rounded bg-gray-100 whitespace-pre-wrap">
      <p class="font-mono text-gray-700">路径：{{ filePath }}</p>
      <pre class="mt-2">{{ fileContent }}</pre>
    </div>
  </div>
</template>
